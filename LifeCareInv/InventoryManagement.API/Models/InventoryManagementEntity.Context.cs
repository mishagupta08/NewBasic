...
namespace InventoryManagement.API.Models
{
    ...
    public partial class InventoryEntities : DbContext
    {
        ...
        public virtual ObjectResult<sp_Login_Result> sp_Login(string action, string userName, string password, string firstName, string lastName, string mobileNo, string formNo, string activeStatus, string fax, string address, string city, Nullable<int> cityCode, string district, Nullable<int> districtCode, Nullable<int> stateCode, Nullable<int> pinCode, Nullable<int> countryId, string randomId, string countryName, Nullable<int> iDNO, Nullable<int> prodId, Nullable<decimal> userPoints)
        {
            var actionParameter = action != null ?
                new ObjectParameter("Action", action) :
                new ObjectParameter("Action", typeof(string));
