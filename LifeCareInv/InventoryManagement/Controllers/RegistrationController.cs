...
namespace InventoryManagement.Controllers
{
    ...
    public class RegistrationController : Controller
    {
        ...
        [SessionExpire]
        public ActionResult ApproveFranchise()
        ...
        [SessionExpire]
        public ActionResult GetAllAppoveFranchiseList(bool IsSupplier)
        {
            List<ApprovefranchiseList> objListModel = new List<ApprovefranchiseList>();
            objListModel = objRegistrationManager.GetAllAppoveFranchiseList(IsSupplier);
        ...
        [SessionExpire]
        public ActionResult AddEditApproveFranchise (string IsActionName, string PartyCode ,string Approveid)
        {
            ...
            if (IsActionName == "Edit")
            {
                ...
                if (!string.IsNullOrEmpty(PartyCode))
                {
                    ...
                    objModel = objRegistrationManager.GetApproveParyOnPartyCode(PartyCode, false,  Approveid);
        ...
        public ActionResult GetPartyCodeStr(string SelectedParentPartyCode,string SelectedGroupId)
        {
         ...
         [HttpPost]
          public ActionResult SavePartyApproveDetails(PartyModel objPartyModel)
        {
            ResponseDetail objResponse = new ResponseDetail();
            objPartyModel.LoginUser = Session["LoginUser"] as User;
            PartyModel objModel = new PartyModel();

            objModel.PartyCode = objRegistrationManager.GetPartyCode(objPartyModel.ParentPartyCode.ToString(), objPartyModel.GroupId.ToString());
            objPartyModel.PartyCode = objModel.PartyCode;
               // Session["PartyCode"] = PartyCode;
           
         

           // objPartyModel.PartyCode = Session["PartyCode"].ToString();
            objResponse = objRegistrationManager.SavePartyApproveDetails(objPartyModel);
        ...
        public ActionResult SavePartyDetails(PartyModel objPartyModel)
        {
         ...
         public ActionResult DeleteApprovePartyDetails(PartyModel objPartyModel)
        {
            ResponseDetail objResponse = new ResponseDetail();
            objPartyModel.LoginUser = Session["LoginUser"] as User;
            objResponse = objRegistrationManager.DeleteApprovePartyDetails(objPartyModel);
            return Json(objResponse, JsonRequestBehavior.AllowGet);
        }
